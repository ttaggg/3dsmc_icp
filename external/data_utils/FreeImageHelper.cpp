...
FreeImage::FreeImage(unsigned int width, unsigned int height, unsigned int nChannels) : w(width), h(height), nChannels(nChannels), data(new float[nChannels * width * height])
{
}
